...
%}
  ...
  \myaddplot{stats_ceb}{DuckDB}{}{color6}{color6!50};
  \myaddplot{stats_ceb}{DuckDB}{-LearnRewrite}{color4}{color4};
  \myaddplot{stats_ceb}{DuckDB}{-R-Bot-Gemini}{tugb}{tugb};
  \myaddplot{stats_ceb}{DuckDB}{-gemini-2.5-pro}{tug}{tug};
