...
%}
  ...
  \myaddplot{stats}{DuckDB}{}{color6}{color6!50};
  \myaddplot{stats}{DuckDB}{-LearnRewrite}{color4}{color4};
  \myaddplot{stats}{DuckDB}{-R-Bot-Gemini}{tugb}{tugb};
  \myaddplot{stats}{DuckDB}{-gemini-2.5-pro}{tug}{tug};
