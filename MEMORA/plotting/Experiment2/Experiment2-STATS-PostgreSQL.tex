...
%}
  ...
  \myaddplot{stats}{PostgreSQL}{}{color6}{color6!50};
  \myaddplot{stats}{PostgreSQL}{-LearnRewrite}{color4}{color4};
  \myaddplot{stats}{PostgreSQL}{-R-Bot-Gemini}{tugb}{tugb};
  \myaddplot{stats}{PostgreSQL}{-gemini-2.5-pro}{tug}{tug};
