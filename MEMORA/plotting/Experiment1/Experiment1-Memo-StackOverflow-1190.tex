...
\makeatother
\addplot [forget plot,draw=none] coordinates{(sql, 1) (logical_memo_nr, 1) (logical_memo_r, 1) (physical_memo, 1)};
}
\makeatother
...
\resetstackedplots
\myaddplotcost{stackoverflow-1190}{sql}{18}{tug};
\resetstackedplots
\myaddplotcost{stackoverflow-1190}{logical_memo_nr}{6}{tugb};
\resetstackedplots
\myaddplotcost{stackoverflow-1190}{logical_memo_r}{-6}{color4};
\resetstackedplots
\myaddplotcost{stackoverflow-1190}{physical_memo}{-18}{black};
\end{axis}
