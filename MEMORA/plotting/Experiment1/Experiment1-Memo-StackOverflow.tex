...
\resetstackedplots
\myaddplotcost{stackoverflow}{sql}{18}{tug};
\resetstackedplots
\myaddplotcost{stackoverflow}{logical_memo_nr}{6}{tugb};
\resetstackedplots
\myaddplotcost{stackoverflow}{logical_memo_r}{-6}{color4};
% \resetstackedplots
% \myaddplotcost{stackoverflow}{physical_memo}{-18}{black};
\end{axis}
