...
\makeatother
\addplot [forget plot,draw=none] coordinates{(sql, 0) (logical_memo_nr, 0) (logical_memo_r, 0) (physical_memo, 0)};
}
\makeatother
...
\resetstackedplots
\myaddplotcost{publicbibenchmark}{sql}{18}{tug};
\resetstackedplots
\myaddplotcost{publicbibenchmark}{logical_memo_nr}{6}{tugb};
\resetstackedplots
\myaddplotcost{publicbibenchmark}{logical_memo_r}{-6}{color4};
\resetstackedplots
\myaddplotcost{publicbibenchmark}{physical_memo}{-18}{black};
\end{axis}
