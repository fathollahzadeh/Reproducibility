create index idx_store_sales_covering on store_sales
(
	ss_sold_date_sk asc,
	ss_net_profit asc,
	ss_sales_price asc,
...
;
create index index_catalog_sales on catalog_sales
(
	cs_sold_date_sk asc,
	cs_item_sk asc,
...
create index dta_index_catalog_sales_2 on catalog_sales
(
	cs_promo_sk asc,
