...
CREATE TABLE users (
  Id bigint NOT NULL,
  Reputation bigint DEFAULT NULL,
...
COPY users FROM 'users.csv' (DELIMITER ',', QUOTE '"', nullstr 'NULL');
COPY posts FROM 'posts.csv' (DELIMITER ',', QUOTE '"', nullstr 'NULL');
COPY postLinks FROM 'postLinks.csv' (DELIMITER ',', QUOTE '"', nullstr 'NULL');
COPY postHistory FROM 'postHistory.csv' (DELIMITER ',', QUOTE '"', nullstr 'NULL');
COPY comments FROM 'comments.csv' (DELIMITER ',', QUOTE '"', nullstr 'NULL');
COPY votes FROM 'votes.csv' (DELIMITER ',', QUOTE '"', nullstr 'NULL');
COPY badges FROM 'badges.csv' (DELIMITER ',', QUOTE '"', nullstr 'NULL');
COPY tags FROM 'tags.csv' (DELIMITER ',', QUOTE '"', nullstr 'NULL');