...
COPY aka_name from 'aka_name.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY aka_title from 'aka_title.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY cast_info from 'cast_info.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY char_name from 'char_name.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY comp_cast_type from 'comp_cast_type.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY company_name from 'company_name.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY company_type from 'company_type.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY complete_cast from 'complete_cast.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY info_type from 'info_type.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY keyword from 'keyword.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY kind_type from 'kind_type.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY link_type from 'link_type.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY movie_companies from 'movie_companies.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY movie_info from 'movie_info.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY movie_info_idx from 'movie_info_idx.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY movie_keyword from 'movie_keyword.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY movie_link from 'movie_link.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY name from 'name.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY person_info from 'person_info.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY role_type from 'role_type.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');
COPY title from 'title.csv' (DELIMITER ',', QUOTE '"', ESCAPE '\');