...
copy PostHistoryTypes from 'PostHistoryTypes.csv' with (delimiter ',', format csv, null '');
copy LinkTypes from 'LinkTypes.csv' with (delimiter ',', format csv, null '');
copy PostTypes from 'PostTypes.csv' with (delimiter ',', format csv, null '');
copy CloseReasonTypes from 'CloseReasonTypes.csv' with (delimiter ',', format csv, null '');
copy VoteTypes from 'VoteTypes.csv' with (delimiter ',', format csv, null '');
copy Users from 'Users.csv' with (delimiter ',', format csv, null '');
copy Badges from 'Badges.csv' with (delimiter ',', format csv, null '');
copy Posts from 'Posts.csv' with (delimiter ',', format csv, null '');
copy Comments from 'Comments.csv' with (delimiter ',', format csv, null '');
copy PostHistory from 'PostHistory.csv' with (delimiter ',', format csv, null '');
copy PostLinks from 'PostLinks.csv' with (delimiter ',', format csv, null '');
copy Tags from 'Tags.csv' with (delimiter ',', format csv, null '');
copy Votes from 'Votes.csv' with (delimiter ',', format csv, null '');
