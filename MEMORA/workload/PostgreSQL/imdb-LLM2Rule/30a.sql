SELECT MIN("t5"."info") AS "movie_budget", MIN("movie_info_idx"."info") AS "movie_votes", MIN("t6"."name") AS "writer", MIN("t7"."title") AS "complete_violent_movie"
FROM "complete_cast"
INNER JOIN (SELECT *
FROM "comp_cast_type"
...
INNER JOIN (SELECT *
FROM "title"
WHERE "production_year" > 2000) AS "t7" ON "t5"."movie_id" = "t7"."id"