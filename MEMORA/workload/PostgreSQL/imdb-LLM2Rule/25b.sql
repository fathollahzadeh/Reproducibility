SELECT MIN("t3"."info") AS "movie_budget", MIN("movie_info_idx"."info") AS "movie_votes", MIN("t4"."name") AS "male_writer", MIN("t5"."title") AS "violent_movie_title"
FROM (SELECT *
FROM "cast_info"
...
INNER JOIN (SELECT *
FROM "title"
WHERE "production_year" > 2010 AND "title" LIKE 'Vampire%') AS "t5" ON "t3"."movie_id" = "t5"."id"