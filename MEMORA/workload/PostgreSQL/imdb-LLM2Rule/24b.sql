SELECT MIN("char_name"."name") AS "voiced_char_name", MIN("t4"."name") AS "voicing_actress_name", MIN("t6"."title") AS "kung_fu_panda"
FROM "aka_name"
...
INNER JOIN (SELECT *
FROM "title"
WHERE "production_year" > 2010 AND "title" LIKE 'Kung Fu Panda%') AS "t6" ON "t3"."movie_id" = "t6"."id"