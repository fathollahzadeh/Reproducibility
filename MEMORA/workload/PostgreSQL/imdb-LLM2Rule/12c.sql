SELECT MIN("t"."name") AS "movie_company", MIN("t4"."info") AS "rating", MIN("t5"."title") AS "mainstream_movie"
FROM (SELECT *
FROM "company_name"
...
INNER JOIN (SELECT *
FROM "title"
WHERE "production_year" >= 2000 AND "production_year" <= 2010) AS "t5" ON "t3"."movie_id" = "t5"."id"