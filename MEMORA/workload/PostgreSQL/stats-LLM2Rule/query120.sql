...
FROM "posthistory"
WHERE "creationdate" >= TIMESTAMP '2010-07-19 19:52:31'
...
FROM "users"
WHERE "creationdate" >= TIMESTAMP '2010-07-27 02:56:06' AND "creationdate" <= TIMESTAMP '2014-09-10 10:44:00'
GROUP BY "id"
HAVING "$cor1"."owneruserid" = "id") AS "t7") AS "$cor0",
LATERAL (SELECT "userid", COUNT(*) AS "EXPR$0"
FROM "badges"
GROUP BY "userid"
HAVING "userid" = "$cor0"."id") AS "t10"